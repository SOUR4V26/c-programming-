 ...
 for(y=1;y<=30;y++)                                                 // display height is taken 30 and display width is taken 80
    {
      for(x=1;x<=80;x++)
        {
            if(y==1||y==30||x==1||x==80) printf("%c",176);

            else
            {
               if(y==fposy&&x==fposx) {printf("\033[1;31m");printf("%c",254);printf("\033[1;37m");}
               else if(y==(sposy)&&x==(sposx)){printf("\033[1;33m");printf("%c",229);printf("\033[1;37m");} 
               else printf(" ");
            }
        }
                 printf("\n");
